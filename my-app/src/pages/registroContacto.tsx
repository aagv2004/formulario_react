...
import { registrarContacto } from '@/Firebase/Promesas';
        ...
        <>
            <main>
                ...
                <div className='cajaBase'>
                    ...
                    <Button type='submit' variant='success' className='btnRegistroContacto' onClick={registrar}>Registrar Contacto</Button>
                </div>
            </main>
        </>
    );
